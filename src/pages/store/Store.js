...
import imgHuman from "../../assets/images/store-human-1.jpg";
    ...
    <main className="main">
      <section className="top" id="top">
        <div className="container">
          <div className="top__between">
            <h2 className="top__title">
              Store.
              <strong className="top__strong">
                The best way to buy the products you love.
              </strong>
            </h2>
            <div className="top__end">
              <div className="top__exam">
                <img
                  src={imgHuman}
                  style={{ width: "25px" }}
                  alt=""
                ...
                <div className="top__card">
                  <h3 className="top__h3">Need shopping help?</h3>
                  <p className="top__text">Ask a Specialist</p>
                </div>
              </div>
              <div className="top__exam">
                <svg
                ...
                <div className="top__card">
                  <h3 className="top__h3">Visit an Apple Store</h3>
                  <p className="top__text">Find one near you</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bottom" id="bottom">
        <div className="bottom__info">
          {STORE.map((el) => (
            <div id="el" key={el.id} className="bottom__card">
              <img src={el.img} alt="" className="bottom__img" />
              <h2 className="bottom__title">{el.title}</h2>
            </div>
          ))}
        </div>
      </section>
